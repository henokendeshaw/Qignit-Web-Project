			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6 offset-lg-3">
						<div class="section_title text-center">qignit store albums</div>
					</div>
				</div>
					...
					<div class="col">
						<div class="page_nav">
							<ul class="d-flex flex-row align-items-start justify-content-center">
								<li class="active"><a href="category.html">popular</a></li>
								<li><a href="category.html">New Relaeas</a></li>
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name"><a href="product.html">{{$item->Album_Name}}</a></div>
											<div class="product_category"><a href="category.html">Gener:{{$item->Gener}}</a></div>
										</div>
									</div>
									<div class="ml-auto text-right">
										<div class="rating_r rating_r_4 home_item_rating"><i></i><i></i><i></i><i></i><i></i></div>
										<div class="product_price text-right">{{$item->Price}}<span>.Birr</span></div>
									</div>
								</div>
								<div class="product_buttons">
									<div class="text-right d-flex flex-row align-items-start justify-content-start">
										...
										<div class="product_button product_cart text-center d-flex flex-column align-items-center justify-content-center">
											<div><div><a href="{{route('addToCart', ['id' => $item->id])}}" role="button"><img src="images/cart.svg" class="svg" alt=""></a><div>+</div></div></div>
										</div>
									</div>
								</div>
							</div>
